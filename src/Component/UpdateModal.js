            ...
            <Box sx={style}>
                <div>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Typography variant="h6" component="h2" sx={{ backgroundColor: 'white', borderRadius: 2, textAlign: 'center' }}>
                                <h3>{name}</h3>
                            </Typography>
                        </Grid>
                        ...
                        <Grid item xs={12}>
                            <Button variant="outlined" onClick={()=> updateInformation(id)}>Update</Button>
                        </Grid>
                    </Grid>
                </div>
            </Box>
