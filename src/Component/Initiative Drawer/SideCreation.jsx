      ...
      component="form"
          ...
          <Box>
              ...
              required
				...
				{/*stat blocks */}
				<Grid container xs={12}  sx={{ display:'flex', justifyContent:'center', flexWrap:'wrap', pt: 2, pb: 2 }}>
					<Grid xs={3.5} sm={3.25} lg={2} direction="column" sx={{ borderRadius: 2 }}>
						<InputLabel sx={{textAlign:'center', color: 'white' }}>HP</InputLabel>
						<TextField
							type="number"
							variant="outlined"
							value={monsterHP}
                ...
                boxSizing:'border-box',
					...
					<Grid xs={3.5} sm={3.25} lg={2} sx={{ borderRadius: 2 }}>
						<InputLabel sx={{textAlign:'center', color: 'white' }} htmlFor="bootstrap-input">
							Init
						</InputLabel>
						<TextField
							type="number"
