...
function BottomAlert ({ open, severity, message }) {
  return (
    <div className={`bottom-alert ${severity}`}>
      {message}
    </div>
  );
}
    ...
    <React.Fragment>
      ...
      >
        <Dialog open={open} onClose={handleCancel}>
          ...
          <Snackbar error={true} alert={alertMessage} setAlertSeverity={setAlertSeverity} open={showAlert} handleShowAlertClickO={handleShowAlertClickO} handleShowAlertClickC={handleShowAlertClickC} />
        </Dialog>
      </Backdrop>
    </React.Fragment>
    </div>
