    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <FormLabel sx={{color:"black",fontStyle: 'oblique', fontFamily:'Roboto'}}> How do you want to do this? </FormLabel>
            <TextField
              value=""
            ...
            >
              <Button variant="contained" color="success" onClick={handleClick} sx={{marginRight:0}}>
                Login
              </Button>
              <Register />
