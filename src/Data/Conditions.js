export const Conditions = [
    {
        name: 'blinded',
        definition: 'You can’t see. All normal terrain is difficult terrain to you. You can’t detect anything using vision. You automatically critically fail Perception checks that require you to be able to see, and if vision is your only precise sense, you take a -4 status penalty to Perception checks. You are immune to visual effects. Blinded overrides dazzled.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: null,
    ...
    {
        name: 'clumsy',
        definition: 'Your movements become clumsy and inexact. Clumsy always includes a value. You take a status penalty equal to the condition value to Dexterity-based checks and DCs, including AC, Reflex saves, ranged attack rolls, and skill checks using Acrobatics, Stealth, and Thievery.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: -1,
    ...
    {
        name: 'dazzled',
        definition: 'definition Your eyes are overstimulated. If vision is your only precise sense, all creatures and objects are concealed from you.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: null,
    ...
    {
        name: 'encumbered',
        definition: 'You are carrying more weight than you can manage. While you’re encumbered, you’re clumsy 1 and take a 10-foot penalty to all your Speeds. As with all penalties to your Speed, this can’t reduce your Speed below 5 feet.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: null,
    ...
    {
        name: 'enfeebled',
        definition: 'Youre physically weakened. Enfeebled always includes a value. When you are enfeebled, you take a status penalty equal to the condition value to Strength-based rolls and DCs, including Strength-based melee attack rolls, Strength-based damage rolls, and Athletics checks.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: null,
    ...
    {
        name: 'fatigued',
        definition: 'Youre tired and cant summon much energy. You take a –1 status penalty to AC and saving throws. You cant use exploration activities performed while traveling, such as those listed here.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: -1,
    ...
    {
        name: 'grabbed',
        definition: 'Youre held in place by another creature, giving you the flat-footed and immobilized conditions. If you attempt a manipulate action while grabbed, you must succeed at a DC 5 flat check or it is lost; roll the check after spending the action, but before any effects are applied.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: -2,
    ...
    {
        name: 'immobilized',
        definition: 'You cant use any action with the move trait. If youre immobilized by something holding you in place and an external force would move you out of your space, the force must succeed at a check against either the DC of the effect holding you in place or the relevant defense (usually Fortitude DC) of the monster holding you in place.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: null,
    ...
    {
        name: 'indifferent',
        definition: 'This condition reflects a creatures disposition toward a particular character, and only supernatural effects (like a spell) can impose this condition on a PC. A creature that is indifferent to a character doesnt really care one way or the other about that character. Assume a creatures attitude to a given character is indifferent unless specified otherwise.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: null,
    ...
    {
        name: 'petrified',
        definition: 'You have been turned to stone. You can’t act, nor can you sense anything. You become an object with a Bulk double your normal Bulk (typically 12 for a petrified Medium creature or 6 for a petrified Small creature), AC 9, Hardness 8, and the same current Hit Points you had when alive. You don’t have a Broken Threshold. When you’re turned back into flesh, you have the same number of Hit Points you had as a statue. If the statue is destroyed, you immediately die. While petrified, your mind and body are in stasis, so you don’t age or notice the passing of time.',
        conditionEffects: [
            {
                stage: 1,
                acEffect: null,
